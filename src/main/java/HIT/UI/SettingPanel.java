 ...
 * 设置面板
 */
public class SettingPanel extends JPanel {//包含了登陆和关于
    ...
    private JPanel getCenterPanel() {
        ...
        JLabel labelOption = new JLabel("登录选项");
        JLabel labelAbout = new JLabel("关于");
        Font fontListItem = new Font("Default", 0, 15);
